...
@interface CPDFPageEditViewCell ()

@property (nonatomic, strong) UIButton *selectButton;

@end

@implementation CPDFPageEditViewCell
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [_selectButton setImage:[UIImage imageNamed:@"CPageEditToolBarImageSelectOn" inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
        [self.imageView addSubview:_selectButton];
